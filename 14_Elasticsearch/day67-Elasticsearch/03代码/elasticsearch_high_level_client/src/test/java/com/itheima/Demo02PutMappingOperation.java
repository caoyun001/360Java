...
public class Demo02PutMappingOperation {
     ...
     * 1.创建请求对象，配置映射
     *   设置索引库
     *   设置类型：在highLevelRESTClient，默认的类型_doc
     *   设置请求体
     * 2.客户端发送请求对象，获取响应对象
     * 3.打印响应结果信息
     */
    ...
    public void putMapping() throws IOException {
        //1.创建请求对象，配置映射
        PutMappingRequest request = new PutMappingRequest("heima2");//设置索引库
        //构建json对象的工厂对象
    ...
    public void getMapping() throws IOException {
        ...
        //设置索引库
        request.indices("heima1");
        //2.客户端发送请求对象，获取响应对象
        GetMappingsResponse response = client.indices().getMapping(request, RequestOptions.DEFAULT);
        //3.打印响应结果信息
        System.out.println("mappings::"+response.mappings().get("heima1").getSourceAsMap());
    }
}
