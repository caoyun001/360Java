        ...
        <tr>
            <td colspan="9">
                <form action="/permission?operator=queryByWhere" method="post">
                    <input type="text" name="name"> 权限名称查询 <input type="text" name="keyword"> 权限编码 <input type="submit"
                                                                                                          value="查询" class="btn btn-default">
                </form>
                    ...
                    <a class="btn btn-default btn-sm"
                       href="${pageContext.request.contextPath}/permission?operator=queryById&id=${permission.id}">修改</a>
                        <%--
                           ...
                           javasctipt:void(0)
                        --%>
                    <a class="btn btn-default btn-sm" href="javascript:void(0)" onclick="del(${permission.id})">删除</a>
                </td>
            </tr>
        </c:forEach>
